...
class UNet(nn.Module):
    ...
    def __init__(self, n_channels, n_classes, is_bilinear=False):
        ...
        self.up1 = (Up(1024, 512 // factor, is_bilinear))
        self.up2 = (Up(512, 256 // factor, is_bilinear))
        self.up3 = (Up(256, 128 // factor, is_bilinear))
...
if __name__ == '__main__':
    test_unet = UNet(1, 1024)
    out = test_unet(torch.rand(1, 1, 64, 64))
    assert out.shape == torch.Size([1, 1024, 64, 64])

    summary(test_unet, (1, 64, 64), device='cpu')
